...
def initialize_dataFrame():
   # header=["seq", "seq_length", "g4motif", "length", "loops", "G-quartet", "maxlbase", "minlbase", "G", "C", "GG", "CC"]
    header=["seq",	"seq_length","g4motif","length","loops","G-quartet","maxlbase",	"minlbase",	"G","C","GG","CC","g4_predg4_prob","mfe_pred"]
...
def update_dataFrame(features, reg, seq, ref):
    ...
    features['g4_predg4_prob'].append(int(findall(ref,'g4_predg4_prob')*100/len(ref)))
    features['mfe_pred'].append(int(findall(ref, 'mfe_pred') * 100 / len(ref)))
    return features
